class DCFSlideshowTheme {
  constructor(slideshows, openCaption, closeCaption) {
  ...
  initialize() {
    ...
    Array.prototype.forEach.call(this.slideshows, (slideshow) => {
      // Slideshow Controls
      ...
      Array.prototype.forEach.call(ctrls, (ctrl) => {
        if (ctrl.getAttribute('id') === 'previous') {
          ...
          ctrlButton.innerHTML =
            ...
            '<path d="M21.746.064a.504.504 0 0 0-.504.008l-19 11.5a.499.499 0 0 0-.001.856l19 11.5A.501.501 0 0 0 22 23.5V.5a.5.5 0 0 0-.254-.436z"></path>' +
            '</svg>';
        }
      ...
      Array.prototype.forEach.call(figures, (figure) => {
        ...
        captionBtn.innerHTML = '<svg class="dcf-h-4 dcf-w-4 dcf-fill-current" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">' +
    ...
    Array.prototype.forEach.call(slideBtns, (slideBtn) => {
      slideBtn.classList.add('dcf-d-flex', 'dcf-ai-center', 'dcf-pt-4', 'dcf-pd-4', 'unl-cream');
    });
