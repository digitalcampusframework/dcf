...
export default class DCFSearchSelect {
  ...
  constructor(selectElement, options = {}) {
    ...
    this.searchAndSelectElement.innerHTML = `
      <div class="dcf-search-and-select-search-area-single ${ this.searchAreaClassList.join(' ') }" >
        <input
    ...
    if (this.multiple) {
        ...
        // This is the core markup for the component
        this.searchAndSelectElement.innerHTML = `
        <div class="dcf-search-and-select-search-area-multiple ${ this.searchAreaClassList.join(' ') }" >
  ...
  #filterAvailableItems() {
    ...
    if (noItemsFound) {
      ...
      noItemsFoundElement.innerHTML = `
        <li class="${ this.availableItemsNoResultsClassList.join(' ') }" role="option">
          No results found
        </li>
      `;
