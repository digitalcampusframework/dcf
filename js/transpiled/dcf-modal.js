...
function () {
  ...
  _createClass(DCFModal, [{
    ...
    value: function openModal(modalId, openBtnId) {
      ...
      var lastTabFocusEl = tabFocusEls[tabFocusEls.length - DCFUtility.magicNumbers('int1')]; // Send focus to the modal
    ...
    value: function initialize() {
      ...
      for (var modalIndex = 0; modalIndex < this.modals.length; modalIndex++) {
        ...
        modalHeadings[DCFUtility.magicNumbers('int0')].id = modalHeadingId; // Append modals to body so that elements outside of modal can be hidden when modal is open
