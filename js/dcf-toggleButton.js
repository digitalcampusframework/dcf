...
export class DCFToggleButtonTheme {
  constructor() {
    ...
    this.toggleElementAnimation = (toggleElement) => {
      ...
      const options = {
        duration: this.toggleElementAnimationDuration,
        fill: 'forwards'
      };
...
export class DCFToggleButton {
  ...
  initialize() {
    ...
    this.toggleButtons.forEach((toggleButton) => {
      ...
      const toggleButtonStartExpanded = toggleButton.dataset.startExpanded ?? 'false';
      ...
      if (this.theme.toggleButtonInnerHTML && toggleButton.innerHTML === '') {
      ...
      toggleElement.getAttribute('aria-labelledby') !== toggleButton.id) {
        ...
        console.log(toggleElement.getAttribute('aria-labelledby'), toggleButton.id);
      ...
      if (toggleButtonStartExpanded === 'true') {
        ...
        toggleElement.classList.add('dcf-opacity-0', 'dcf-invisible'); // This is only used here since it will not work with animations
      }
  ...
  toggleSwitched(toggleButton, toggleElement, state = '') {
    ...
    // Toggle Off
      ...
      toggleElement.classList.remove('dcf-opacity-1', 'dcf-pointer-events-auto');
      toggleElement.classList.add('dcf-pointer-events-none');
      // toggleElement.classList.add('dcf-opacity-0', 'dcf-invisible'); // These are removed due to animations
